...
## 菜品研发与视觉核心：
1. 视觉信息压缩：画面必须高度概括！依靠大面积、干净的天然色块和明确的色彩边界来传递视觉，让人一眼看上去感觉极其简单、干净、舒适。
...
格式示例（以治愈系大地撞色为例）：
PROMPT 1: "[菜品1的概括性色块、漫画式细节与标志性吉卜力高光描述], Ghibli aesthetic, inspired by Soviet constructivism painting, dynamic composition of large solid color-blocks, compressed textures and details for a clean look, on a flat matte deep terracotta ceramic dish, set against a solid muted teal-green background, illuminated by bright cozy sunlight with clean simple shadows, visually comforting, full of life and élan vital, 8k, cinematic lighting"
PROMPT 2: "[菜品2的概括性色块、漫画式细节与标志性吉卜力高光描述], Ghibli aesthetic, inspired by Soviet constructivism painting, dynamic composition of large solid color-blocks, compressed textures and details for a clean look, on a flat matte deep terracotta ceramic dish, set against a solid muted teal-green background, illuminated by bright cozy sunlight with clean simple shadows, visually comforting, full of life and élan vital, 8k, cinematic lighting"`;
